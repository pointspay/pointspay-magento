...
class PrivateKeyDataBuilder extends \Pointspay\Pointspay\Gateway\Request\PrivateKeyDataBuilder
{
    /**
    ...
    {
            $request['clientConfig']['key_info']['private_key'] = '-----BEGIN PRIVATE KEY-----
