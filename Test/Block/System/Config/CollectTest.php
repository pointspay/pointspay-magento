...
use Pointspay\Pointspay\Block\System\Config\Collect;
...
class CollectTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->collect = $objectManager->getObject(
            ...
            [
                ...
                'buttonName' => 'Button',
                'template' => 'Pointspay_Pointspay::system/config/redirect.phtml',
                'data' => ['area' => 'adminhtml']
            ]
        );
    }
    ...
    public function testGetTranslitButton()
    {
        $objectManager = new ObjectManager($this);
        $this->collect = $objectManager->getObject(
            Collect::class,
        ...
        $result = $this->collect->getTranstlitedName();
        $this->assertIsString($result);
    }
    ...
    public function testGetReturnUrlReturnsUrl()
    {
        $result = $this->collect->getReturnUrl();
        $this->assertIsString($result);
    }
}
